...
const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "Product",
      name: "Male Vitamin — Male Performance Enhancement",
      description:
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Most male supplements target just one thing — either blood flow, or testosterone, or stamina. Male Vitamin is engineered as a comprehensive performance system that addresses ALL the factors that determine your bedroom performance: blood flow (L-Arginine), testosterone (Zinc, Fenugreek), stamina (Maca, Ginseng), and desire (Tribulus). This multi-pathway approach means you're not just fixing one piece of the puzzle — you're optimizing every system that contributes to total sexual performance. It's the difference between upgrading one part of a car and building a high-performance machine.",
          },
        },
        {
          "@type": "Question",
...
export default function MalePerformancePage() {
  return (
    <MiniSitePage
      ...
      pageDescription="Underperforming in the bedroom? Male Vitamin's all-in-one performance formula delivers harder stamina, stronger drive and rock-solid confidence."
      canonicalUrl="https://malevitamin.co.za/male-performance"
      heroH1="MALE PERFORMANCE SUPPLEMENT FOR TOTAL DOMINANCE"
      heroSubheadline="You weren't built for mediocre performance — you were built to dominate. Male Vitamin is the all-in-one formula that addresses every factor that determines your bedroom performance: blood flow, testosterone, stamina, and desire. Six powerful ingredients working together in one supplement so you can perform at your absolute best, every single time. No more hoping for a good night — you make every night yours."
      ...
      faqs={[
        {
          ...
          answer:
            "Most male supplements target just one thing — either blood flow, or testosterone, or stamina. Male Vitamin is engineered as a comprehensive performance system that addresses ALL the factors that determine your bedroom performance: blood flow (L-Arginine), testosterone (Zinc, Fenugreek), stamina (Maca, Ginseng), and desire (Tribulus). This multi-pathway approach means you're not just fixing one piece of the puzzle — you're optimizing every system that contributes to total sexual performance. It's the difference between upgrading one part of a car and building a high-performance machine.",
        },
        {
          question: "How does it improve overall performance?",
          answer:
            "Male Vitamin improves performance through four distinct mechanisms working together. First, L-Arginine boosts nitric oxide for stronger, firmer erections. Second, Zinc and Fenugreek optimize testosterone for drive and confidence. Third, Maca Root and Ginseng build stamina so you last longer and recover faster. Fourth, Tribulus enhances libido so you actually want to perform. When all four systems are firing at peak capacity, the result is comprehensive bedroom performance that addresses firmness, endurance, desire, and confidence simultaneously.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Male Vitamin is formulated based on extensive clinical research and has helped thousands of men across South Africa. However, individual results can vary based on your starting hormone levels, overall health, and consistency of use. We recommend giving the formula at least 4-6 weeks to work — real, sustainable improvements take time as your body recalibrates. If after consistent use you're not satisfied, our customer support team is here to help. We're committed to your satisfaction because we believe in this product.",
        },
        {
          question: "Is this a long-term solution?",
          answer:
            "Yes — Male Vitamin is designed as a long-term performance optimization system, not a quick fix. The ingredients work by supporting and enhancing your body's natural processes: testosterone production, blood flow, energy metabolism, and hormonal balance. These are ongoing bodily functions that benefit from consistent nutritional support, just like your muscles benefit from consistent protein intake. Most men take Male Vitamin as part of their daily routine and experience sustained performance improvements that get better over time.",
        },
      ]}
